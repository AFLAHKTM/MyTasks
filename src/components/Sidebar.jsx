...
import { LayoutDashboard, CheckSquare, PlusSquare, Calendar, Users, Settings as SettingsIcon, Archive, Sun, Moon, ChevronLeft, ChevronRight, StickyNote, BellRing } from 'lucide-react';
...
export default function Sidebar() {
    ...
    const routes = [
        ...
        { name: 'Alarms', path: '/alarms', icon: <BellRing size={18} /> },
